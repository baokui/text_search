file=$1
Date=$2
input1=VpaOutput_guobk/userhistory_godText/user_join/$Date/user_$file/part-*
hpoutput=VpaOutput_guobk/userhistory_godText/feature/feature_user/$Date/user_$file/
